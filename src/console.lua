...
return {
    ...
    typeKey = function(self, key_name)
        ...
        if key_name == 'c' and ((platform.is_mac and self.modifiers.meta and self.modifiers.shift) or
            (not platform.is_mac and self.modifiers.ctrl and self.modifiers.shift)) then
    ...
    registerCommand = function(self, name, callback, short_description, autocomplete, usage)
        ...
        self.commands[name] = {call = callback, desc = short_description, autocomplete = autocomplete, usage = usage}
    end,
